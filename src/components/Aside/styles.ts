...
export const Container = styled.aside<IContainerProps>`
  ...
  box-shadow: 0 5px 10px ${ props => rgba(props.theme.general.colors.black, 0.05) };
  display: flex;
...
export const Header = styled.header`
  align-items: center;
  display: flex;
  padding: ${ props => props.theme.general.space[7] } ${ props => props.theme.general.space[4] };
  height: 70px;
...
export const MenuItem = styled.a`
  ...
  padding: ${ props => props.theme.general.space[2] } ${ props => props.theme.general.space[3] };
